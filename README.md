...
| [**C2 Intel Feeds**](https://raw.githubusercontent.com/idleadmin/ThreatFeed/refs/heads/main/c2intelipfeed.list) | IN / OUT | Aggregated command-and-control (C2) indicators formatted for firewall consumption | [Link](https://github.com/nwiecz/C2IntelFeedsFGT) |
| [**TOR IP List (Check Point)**](https://raw.githubusercontent.com/idleadmin/ThreatFeed/refs/heads/main/cptorlist.list) | IN | Curated TOR exit node IP list from Check Point threat intelligence | [Link](https://secureupdates.checkpoint.com/IP-list/TOR.txt) |
